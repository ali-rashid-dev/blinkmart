...
export async function main() {
  ...
  const sampleProducts = [
    ...
    {
      name: "K&N’s Chicken Nuggets 500 g",
      slug: "kns-chicken-nuggets-500g",
      description: "Ready to fry crispy halal chicken nuggets.",
      price: 680,
      imageUrl: "https://images.unsplash.com/photo-1562967914-608f82629710?w=800&auto=format&fit=crop&q=80",
      enabled: true,
      categoryId: seededCategories["frozen-foods"],
      brandId: seededBrands["K&N’s"],
    },
    {
      name: "Cooking Oil Pure Canola 1 L",
      slug: "cooking-oil-pure-canola-1l",
      description: "Refined pure canola oil, rich in Vitamin E.",
      price: 520,
    ...
    {
      name: "Chakki Atta Whole Wheat 5 kg",
      slug: "chakki-atta-whole-wheat-5kg",
      description: "100% whole wheat stone ground flour for soft rotis.",
      price: 640,
    ...
    {
      name: "Nestlé Pure Life Water 1.5 L",
      slug: "nestle-pure-life-water-1-5l",
      description: "Purified drinking water with balanced minerals.",
      price: 90,
    ...
    },
    {
      ...
      slug: "dawn-sandwich-bread-large",
      description: "Fresh white sandwich bread, soft slices.",
      price: 160,
      imageUrl: "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=800&auto=format&fit=crop&q=80",
      enabled: true,
      categoryId: seededCategories["roti-bread-bakery"],
    ...
    {
      name: "Lemon Max Dishwashing Liquid 475 ml",
      slug: "lemon-max-dishwashing-liquid-475ml",
      description: "Tough on grease, lemon fresh dishwashing liquid.",
      price: 240,
      imageUrl: "https://images.unsplash.com/photo-1585842378054-ee2e52f94ba2?w=800&auto=format&fit=crop&q=80",
      enabled: true,
      categoryId: seededCategories["household-cleaning"],
      brandId: seededBrands["Green Valley Organic"],
    },
  ];
